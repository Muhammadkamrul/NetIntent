...
# SYSTEM_PROMPT = """Your task is to transform the given network requirements into a formal specification in JSON format.
...
# - Merge arrays for duplicate keys in `reachability`, `waypoint`, and `loadbalancing`.
# - Exclude empty lists or maps when there is no requirement for a specific key.
